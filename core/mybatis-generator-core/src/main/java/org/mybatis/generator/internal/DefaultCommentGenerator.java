...
public class DefaultCommentGenerator implements CommentGenerator {
    ...
    public void addModelClassComment(TopLevelClass topLevelClass,
        ...
        topLevelClass.addJavaDocLine("* "+introspectedTable.getFullyQualifiedTable() + " " + remarks);
        topLevelClass.addJavaDocLine("*/");
    }
    ...
    public void addFieldComment(Field field, IntrospectedTable introspectedTable) {
        ...
        field.addJavaDocLine("/** "+introspectedTable.getRemarks()+" */"); //$NON-NLS-1$
    }
    ...
    @Override
    public void addLombokConstructor(TopLevelClass topLevelClass,ConstructorTypeEnums constructorTypeEnums,JavaVisibility accessLevel) {
        String value  = "@"+constructorTypeEnums.getValue()
                +"(access = AccessLevel."+accessLevel.getValue().toUpperCase().trim()+")";
        topLevelClass.addAnnotation(value);
        topLevelClass.addImportedType(constructorTypeEnums.getPakkage());
